...
void cleanup(){
  ...
  /* FLAMEGPU Agent Export */
	int len = xmachine_memory_Circle_MAX;
	std::ofstream oFile;
	oFile.open("flameagents.txt");
	if (oFile.is_open())
	{
		cudaMemcpy(h_Circles_default, d_Circles, sizeof(xmachine_memory_Circle_list), cudaMemcpyDeviceToHost);
		oFile &lt;&lt; len &lt;&lt; "\n"; 
		for (int i = 0; i &lt; len;i++)
		{
			oFile &lt;&lt; h_Circles_default->x[i] &lt;&lt; "," &lt;&lt; h_Circles_default->y[i] &lt;&lt; "," &lt;&lt; h_Circles_default->z[i] &lt;&lt; "\n";
		}
		oFile.close();
	}
	else
